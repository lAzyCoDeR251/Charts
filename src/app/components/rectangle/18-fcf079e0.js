...
var m = (o, t, e) =>
  t in o
    ? x(o, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (o[t] = e);
var i = (o, t, e) => (m(o, typeof t != "symbol" ? t + "" : t, e), e);
import { L as v, T as f } from "./lightweight-charts.production-891e1a8f.js";
import { g as C } from "./sample-data-c7d89ab8.js";
import { e as a, P as b } from "./plugin-base-a12dadc8.js";
...
class V {
  ...
  update() {
    ...
    (this._p1 = { x: n, y: e }), (this._p2 = { x: g, y: s });
  }
  renderer() {
    return new P(this._p1, this._p2, this._source._options.fillColor);
  }
}
class R {
  constructor(t, e, s, r) {
    ...
    i(this, "_fillColor");
    i(this, "_vertical", !1);
    (this._p1 = t), (this._p2 = e), (this._fillColor = s), (this._vertical = r);
  }
  draw(t) {
    t.useBitmapCoordinateSpace((e) => {
      ...
      (s.fillStyle = this._fillColor),
        this._vertical
          ? s.fillRect(0, r.position, 15, r.length)
          : s.fillRect(r.position, 0, r.length, 15);
    });
  }
}
class _ {
...
const T = {
  ...
  timeLabelFormatter: (o) =>
    typeof o == "string"
      ? o
      : (v(o)
          ? new Date(o.year, o.month, o.day)
          : new Date(o * 1e3)
        ).toLocaleDateString(),
};
class u extends b {
...
class D {
  ...
  _onClick(t) {
    ...
    e !== null && this._addPoint({ time: t.time, price: e });
  }
  _onMouseMove(t) {
    if (!this._drawing || !t.point || !t.time || !this._series) return;
    const e = this._series.coordinateToPrice(t.point.y);
    e !== null &&
      ...
      this._previewRectangle.updateEndPoint({ time: t.time, price: e });
  }
  _addPoint(t) {
    this._points.push(t),
  ...
  _addNewRectangle(t, e) {
    ...
    this._rectangles.push(s), a(this._series).attachPrimitive(s);
  }
  _removeRectangle(t) {
    a(this._series).detachPrimitive(t);
  }
  _addPreviewRectangle(t) {
    (this._previewRectangle = new L(t, t, { ...this._defaultOptions })),
...
const d = (window.chart = f("chart", { autoSize: !0 })),
  w = d.addLineSeries(),
  S = C();
w.setData(S);
new D(d, w, document.querySelector("#toolbar"), { showLabels: !1 });
